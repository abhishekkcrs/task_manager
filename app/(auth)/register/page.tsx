    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-dark px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 mt-2">Get started with Project Tracker</p>
        </div>
          ...
          <form action={action} className="space-y-5">
            ...
            <div>
              ...
              <select
                ...
                name="role"
                defaultValue="MEMBER"
                className="w-full rounded-lg border border-slate-600 bg-slate-800/50 px-4 py-3 text-sm text-slate-100 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition"
              >
                <option value="MEMBER" className="bg-slate-800">Member — can view and update tasks</option>
                <option value="ADMIN" className="bg-slate-800">Admin — full access to all projects</option>
              </select>
            </div>
